...
const CODE_TABS = [
  {
    id: "c-header",
    name: "ornith_tinyml_model.h (Embedded C)",
    path: "server/tinyml_engine.ts",
    lang: "c",
  },
  {
    id: "engine",
    name: "tinyml_engine.ts (Kjerne & Backprop)",
    path: "server/tinyml_engine.ts",
    lang: "typescript",
  },
  {
    id: "server",
    name: "server.ts (REST & SSE Telemetri)",
    path: "server.ts",
    lang: "typescript",
  },
];
    ...
    <div className="flex h-full flex-col overflow-hidden bg-[#0A0A09]">
      ...
      <div className="flex h-11 shrink-0 items-center justify-between border-b border-[rgba(255,255,255,0.06)] bg-[#111111] px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {copied ? (
              <Check className="h-3.5 w-3.5 text-[#77F23B]" />
            ) : (
